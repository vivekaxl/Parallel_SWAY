...
def gale_32_WHERE(problem, population, configuration, values_to_be_passed):
...
def gale_32_Mutate(problem, NDLeafs, configuration):
    #################
    # Mutation Phase
    #################
# Keep track of evals
...
def gale_32_Regen(problem, unusedslot, mutants, configuration):
